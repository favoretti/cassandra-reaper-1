...
public final class BasicSteps {
  ...
  public void a_new_daily_repair_schedule_is_added_for(String clusterName, String keyspace) throws Throwable {
    synchronized (BasicSteps.class) {
  ...
  public void a_new_daily_repair_schedule_is_added_for_the_last_added_cluster(String keyspace) throws Throwable {
    synchronized (BasicSteps.class) {
        ReaperTestJettyRunner runner = RUNNERS.get(RAND.nextInt(RUNNERS.size()));
        Map<String, String> params = Maps.newHashMap();
